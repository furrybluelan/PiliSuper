import 'package:PiliSuper/pages/about/view.dart';
import 'package:PiliSuper/pages/article/view.dart';
import 'package:PiliSuper/pages/article_list/view.dart';
import 'package:PiliSuper/pages/audio/view.dart';
import 'package:PiliSuper/pages/blacklist/view.dart';
import 'package:PiliSuper/pages/danmaku_block/view.dart';
import 'package:PiliSuper/pages/dynamics/view.dart';
import 'package:PiliSuper/pages/dynamics_create_vote/view.dart';
import 'package:PiliSuper/pages/dynamics_detail/view.dart';
import 'package:PiliSuper/pages/dynamics_topic/view.dart';
import 'package:PiliSuper/pages/dynamics_topic_rcmd/view.dart';
import 'package:PiliSuper/pages/fan/view.dart';
import 'package:PiliSuper/pages/fav/view.dart';
import 'package:PiliSuper/pages/fav_create/view.dart';
import 'package:PiliSuper/pages/fav_detail/view.dart';
import 'package:PiliSuper/pages/fav_search/view.dart';
import 'package:PiliSuper/pages/follow/view.dart';
import 'package:PiliSuper/pages/follow_search/view.dart';
import 'package:PiliSuper/pages/follow_type/follow_same/view.dart';
import 'package:PiliSuper/pages/follow_type/followed/view.dart';
import 'package:PiliSuper/pages/history/view.dart';
import 'package:PiliSuper/pages/history_search/view.dart';
import 'package:PiliSuper/pages/home/view.dart';
import 'package:PiliSuper/pages/hot/view.dart';
import 'package:PiliSuper/pages/later/view.dart';
import 'package:PiliSuper/pages/later_search/view.dart';
import 'package:PiliSuper/pages/live_dm_block/view.dart';
import 'package:PiliSuper/pages/live_room/view.dart';
import 'package:PiliSuper/pages/login/view.dart';
import 'package:PiliSuper/pages/main/view.dart';
import 'package:PiliSuper/pages/main_reply/view.dart';
import 'package:PiliSuper/pages/match_info/view.dart';
import 'package:PiliSuper/pages/member/view.dart';
import 'package:PiliSuper/pages/member_dynamics/view.dart';
import 'package:PiliSuper/pages/member_profile/view.dart';
import 'package:PiliSuper/pages/member_search/view.dart';
import 'package:PiliSuper/pages/member_upower_rank/view.dart';
import 'package:PiliSuper/pages/msg_feed_top/at_me/view.dart';
import 'package:PiliSuper/pages/msg_feed_top/like_detail/view.dart';
import 'package:PiliSuper/pages/msg_feed_top/like_me/view.dart';
import 'package:PiliSuper/pages/msg_feed_top/reply_me/view.dart';
import 'package:PiliSuper/pages/msg_feed_top/sys_msg/view.dart';
import 'package:PiliSuper/pages/music/view.dart';
import 'package:PiliSuper/pages/popular_precious/view.dart';
import 'package:PiliSuper/pages/popular_series/view.dart';
import 'package:PiliSuper/pages/search/view.dart';
import 'package:PiliSuper/pages/search_result/view.dart';
import 'package:PiliSuper/pages/search_trending/view.dart';
import 'package:PiliSuper/pages/setting/extra_setting.dart';
import 'package:PiliSuper/pages/setting/pages/bar_set.dart';
import 'package:PiliSuper/pages/setting/pages/color_select.dart';
import 'package:PiliSuper/pages/setting/pages/display_mode.dart';
import 'package:PiliSuper/pages/setting/pages/font_size_select.dart';
import 'package:PiliSuper/pages/setting/pages/logs.dart';
import 'package:PiliSuper/pages/setting/pages/play_speed_set.dart';
import 'package:PiliSuper/pages/setting/play_setting.dart';
import 'package:PiliSuper/pages/setting/privacy_setting.dart';
import 'package:PiliSuper/pages/setting/recommend_setting.dart';
import 'package:PiliSuper/pages/setting/style_setting.dart';
import 'package:PiliSuper/pages/setting/video_setting.dart';
import 'package:PiliSuper/pages/setting/view.dart';
import 'package:PiliSuper/pages/settings_search/view.dart';
import 'package:PiliSuper/pages/space_setting/view.dart';
import 'package:PiliSuper/pages/sponsor_block/view.dart';
import 'package:PiliSuper/pages/subscription/view.dart';
import 'package:PiliSuper/pages/subscription_detail/view.dart';
import 'package:PiliSuper/pages/video/view.dart';
import 'package:PiliSuper/pages/webdav/view.dart';
