...
/// NavBar-embedded favourites page.
class FavNavBarPage extends StatefulWidget {
  const FavNavBarPage({super.key});

  @override
  State<FavNavBarPage> createState() => _FavNavBarPageState();
}

class _FavNavBarPageState extends State<FavNavBarPage>
          ...
          actions: [
            ...
            Obx(
              () => _showVideoFavMenu.value
                  ? IconButton(
                      onPressed: () {
                        if (_favController.loadingState.value
